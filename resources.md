...
* **[Visio](https://www.microsoft.com/en-us/microsoft-365/visio/flowchart-software)** - If you work on a Windows machine and want to make the absolute best looking diagrams, Visio is still king.  No application can match the design flexibility that Visio provides, and for that reason my best looking diagrams have been made in Visio.  With more power comes a higher learning curve, and most people do not require what Visio provides.  Visio requires a license and sometimes exporting to something neutral like a PDF will leave your diagram looking different than it did in the editor.  Still great and a tool I love to use.
* **[draw.io](https://app.diagrams.net/)** - When I'm on my personal MacBook I use draw.io, it supports exporting to several formats, is sufficiently powerful, and supports git. In a world where everything is a subscription, great quality free software is gold. I recommend any prospective network engineer learn how to make great diagrams, and draw.io is a wonderful application to learn.
* **[Lucid Chart](https://www.lucidchart.com/)** - Great solution for cross-platform diagrams, but it comes at the cost of a monthly subscription. Gentler learning curve than Visio and still capable of making great technical diagrams, albeit with fewer design options.
